...
const nodeClasses = ["blueprint-node blueprint-node--web", "blueprint-node blueprint-node--gateway", "blueprint-node blueprint-node--service", "blueprint-node blueprint-node--store", "blueprint-node blueprint-node--queue", "blueprint-node blueprint-node--worker"];
